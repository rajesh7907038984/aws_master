    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_term_goal",
                    models.TextField(help_text="Short-term career goal (1-2 years)"),
                ),
                (
                    "long_term_goal",
                    models.TextField(help_text="Long-term career goal (5+ years)"),
                ),
                (
                    "target_industry",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, help_text="Display order within the section"
                    ),
                ),
                (
                    "is_mandatory",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "named_first_aider",
                    models.TextField(
                        blank=True, help_text="Who is the named first aider?", null=True
                    ),
                ),
                (
                    "named_first_aider_confirmed",
                    models.CharField(
                        blank=True,
                        choices=[("yes", "Yes"), ("no", "No"), ("", "Not Set")],
                        default="",
                ...
                (
                    "health_safety_policy_confirmed",
                    models.CharField(
                        blank=True,
                        choices=[("yes", "Yes"), ("no", "No"), ("", "Not Set")],
                        default="",
                ...
                (
                    "health_safety_manager_confirmed",
                    models.CharField(
                        blank=True,
                        choices=[("yes", "Yes"), ("no", "No"), ("", "Not Set")],
                        default="",
                ...
                (
                    "prohibited_substances_confirmed",
                    models.CharField(
                        blank=True,
                        choices=[("yes", "Yes"), ("no", "No"), ("", "Not Set")],
                        default="",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.PositiveIntegerField(
                        default=1, help_text="Display order of this section"
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether this section is active"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question_text",
                    models.TextField(help_text="The question to be answered"),
                ),
                (
                    "answer_text",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "learner_comment",
                    models.TextField(
                        blank=True, help_text="Learner's comment on progress", null=True
                    ),
                ),
                (
                    "teacher_comment",
                    models.TextField(
                        blank=True, help_text="Teacher/Instructor comment", null=True
                    ),
                ),
                (
                    "evidence_file",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        help_text="Description of the accommodation needed"
                    ),
                ),
