    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="assignments.textsubmissionansweriteration",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="assignments.textsubmissionfield",
            ),
        ),
        migrations.AddField(
            model_name="textsubmissionansweriteration",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="feedback_entries",
                to="assignments.textquestionansweriteration",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="assignments.supportingdocquestion",
            ),
        ),
        migrations.AddField(
            model_name="studentanswer",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="feedback_entries",
                to="assignments.filesubmissioniteration",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="assignments.AssignmentCourse",
                to="courses.course",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="assignments.TopicAssignment",
                to="courses.topic",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="textsubmissioniterationfeedback",
            index=models.Index(
                fields=["iteration", "-created_at"],
                name="assignments_iterati_918ead_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="textsubmissionfield",
            index=models.Index(
                fields=["assignment", "order"], name="assignments_assignm_3df085_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="textsubmissionansweriteration",
            index=models.Index(
                ...
                name="assignments_field_i_4b0dd8_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="textsubmissionansweriteration",
            index=models.Index(
                fields=["field", "submission", "-iteration_number"],
                name="assignments_field_i_0edad4_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["iteration", "-created_at"],
                name="assignments_iterati_aa502d_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="textquestionansweriteration",
            index=models.Index(
                ...
                name="assignments_questio_9bd745_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="textquestionansweriteration",
            index=models.Index(
                fields=["question", "submission", "-iteration_number"],
                name="assignments_questio_8aef78_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddIndex(
            model_name="textquestion",
            index=models.Index(
                fields=["assignment", "order"], name="assignments_assignm_8214b7_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="studentanswer",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["iteration", "-created_at"],
                name="assignments_iterati_f8a5a2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="filesubmissioniteration",
            index=models.Index(
                fields=["submission", "iteration_number"],
                name="assignments_submiss_fba67f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="filesubmissioniteration",
            index=models.Index(
                fields=["submission", "-iteration_number"],
                name="assignments_submiss_8290dc_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddIndex(
            model_name="assignmentsessionlog",
            index=models.Index(
                fields=["assignment", "user", "-start_time"],
                name="assignments_assignm_e3b93f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assignmentsessionlog",
            index=models.Index(
                ...
                name="assignments_session_36c237_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="assignments_assignm_46fc63_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assignmentinteractionlog",
            index=models.Index(
                ...
                name="assignments_interac_6e7747_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assignmentinteractionlog",
            index=models.Index(
                fields=["user", "-created_at"], name="assignments_user_id_df07fb_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="assignments_assignm_8b0a16_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assignmentcomment",
            index=models.Index(
                ...
                name="assignments_submiss_3772c3_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assignmentcomment",
            index=models.Index(
                fields=["author", "created_at"], name="assignments_author__cd682c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assignment",
            index=models.Index(
                fields=["course", "-created_at"], name="assignments_course__45b6d6_idx"
            ),
        ),
    ]
