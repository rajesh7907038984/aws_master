    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger_reason', models.CharField(blank=True, help_text="What triggered this approval review (e.g., 'new_feedback', 'file_resubmission', 'text_revision')", max_length=100, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(blank=True, help_text='Supporting documents for the assignment (Use AssignmentAttachment for new documents)', null=True, storage=core.s3_storage.MediaS3Storage(), upload_to=assignments.models.assignment_file_path)),
                ('content_type', models.CharField(blank=True, help_text='MIME type of the attachment', max_length=100, null=True)),
                ...
                ('allowed_file_types', models.CharField(default='.pdf,.doc,.docx,.txt,.ppt,.pptx,.mp4,.mov,.avi,.wmv', help_text='Comma-separated list of allowed file extensions', max_length=255)),
                ('max_file_size', models.IntegerField(default=104857600, help_text='Maximum file size in bytes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(help_text='Label for the text field', max_length=255)),
                ('placeholder', models.CharField(blank=True, help_text='Placeholder text for the field', max_length=255)),
