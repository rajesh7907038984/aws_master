...
urlpatterns = [
    ...
    path('courses/<int:course_id>/overview/excel/', views.course_overview_excel, name='course_overview_excel'),
    path('courses/<int:course_id>/users/excel/', views.course_users_excel, name='course_users_excel'),
