...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('total_user_limit', models.PositiveIntegerField(default=500, help_text='Maximum total number of users allowed across all branches in this business')),
                ('branch_creation_limit', models.PositiveIntegerField(default=10, help_text='Maximum number of branches that can be created for this business')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
