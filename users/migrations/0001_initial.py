    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family_name', models.CharField(blank=True, help_text='Family name/surname', max_length=255, null=True)),
                ('given_names', models.CharField(blank=True, help_text='Given name(s)/first name(s)', max_length=255, null=True)),
                ...
                ('address_line1', models.CharField(blank=True, help_text='Street address/house number', max_length=255, null=True)),
                ('address_line2', models.CharField(blank=True, help_text='Apartment/Suite/Unit/Building', max_length=255, null=True)),
                ...
                ('job_role', models.CharField(blank=True, help_text='Current or most recent job role', max_length=255, null=True)),
                ...
                ('assigned_instructor', models.ForeignKey(blank=True, help_text='The instructor assigned to this learner.', limit_choices_to={'role': 'instructor'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='instructor_students', to=settings.AUTH_USER_MODEL)),
                ('branch', models.ForeignKey(blank=True, help_text='The branch this user belongs to. Not required for Global Admin users.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='branch_users', to='branches.branch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_name', models.CharField(help_text='Display name for the quiz assignment (defaults to quiz title)', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subject', models.CharField(help_text='Subject or assessment name', max_length=255)),
