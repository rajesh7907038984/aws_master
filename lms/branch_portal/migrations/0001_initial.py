    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "about_text",
                    models.TextField(
                        blank=True, help_text="About section text", null=True
                    ),
                ),
                (
                    "banner_image",
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether this portal is active"
                    ),
                ),
                (
                    "facebook_url",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="Link title/text", max_length=100),
                ),
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether this link is active"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "link_url",
                    models.URLField(blank=True, help_text="Custom link URL", null=True),
                ),
                (
                    "link_text",
                    models.CharField(
                ...
                (
                    "order",
                    models.PositiveIntegerField(
                        default=0, help_text="Order within the grid"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "section_description",
                    models.TextField(
                        blank=True, help_text="Optional section description", null=True
                    ),
                ),
                (
                    "order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(help_text="Section description/content"),
                ),
                (
                    "image",
                    models.ImageField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "admin_notes",
                    models.TextField(
                        blank=True, help_text="Admin notes about this order", null=True
                    ),
                ),
                (
                    "user_notes",
                    models.TextField(
                        blank=True, help_text="Notes from the user", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.PositiveIntegerField(
                        default=1, help_text="Quantity (usually 1 for courses)"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether pre-footer is active"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether this icon is active"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
