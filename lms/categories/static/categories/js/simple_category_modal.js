        ...
        <div class="relative mx-auto p-6 border border-gray-600 w-full max-w-md shadow-2xl rounded-lg bg-gray-800">
            ...
            <form id="categoryForm" class="space-y-4" method="POST" action="/categories/ajax-create/">
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t border-gray-700">
                    <button type="button" class="px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-gray-500 rounded-md shadow-sm hover:bg-gray-700 focus:outline-none" onclick="hideCategoryModal()">
                        Cancel
                    </button>
