...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_of_birth",
                    models.DateField(
                        blank=True, help_text="Date of birth (YYYY-MM-DD)", null=True
                    ),
                ),
                (
                    "sex",
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                ...
                                regex="^[A-Z]{1,2}[0-9][A-Z0-9]? ?[0-9][A-Z]{2}$|^ZZ99 9ZZ$",
                            )
                        ],
                    ),
                ),
                ...
                (
                    "city",
                    models.CharField(
                        blank=True, help_text="City or town", max_length=100, null=True
                    ),
                ),
                (
                    "county",
                ...
                (
                    "is_non_uk_address",
                    models.BooleanField(
                        default=False, help_text="Whether the address is outside the UK"
                    ),
                ),
                (
                    "contact_preference",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (
                                "Honours (First Class / Upper Second / etc.)",
                                "Honours (First Class / Upper Second / etc.)",
                            ),
                ...
                (
                    "key_skills",
                    models.TextField(
                        blank=True, help_text="Key skills and competencies", null=True
                    ),
                ),
                (
                    "employment_data",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, help_text="Initial assessment for English"
                    ),
                ),
                (
                    "initial_assessment_maths",
                    models.BooleanField(
                        default=False, help_text="Initial assessment for Maths"
                    ),
                ),
                (
                    "initial_assessment_subject_specific",
                    models.BooleanField(
                        default=False,
                ...
                (
                    "initial_assessment_other",
                    models.BooleanField(
                        default=False, help_text="Initial assessment for Other skills"
                    ),
                ),
                (
                    "initial_assessment_date",
                    models.DateField(
                        blank=True, help_text="Date of initial assessment", null=True
                    ),
                ),
                (
                    "diagnostic_assessment_english",
                    models.BooleanField(
                        default=False, help_text="Diagnostic assessment for English"
                    ),
                ),
                (
                    "diagnostic_assessment_maths",
                    models.BooleanField(
                        default=False, help_text="Diagnostic assessment for Maths"
                    ),
                ),
                (
                    "diagnostic_assessment_subject_specific",
                    models.BooleanField(
                        default=False,
                ...
                (
                    ...
                    models.DateField(
                        blank=True, help_text="Date of diagnostic assessment", null=True
                    ),
                ),
                (
                ...
                (
                    "initial_assessment_english_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "initial_assessment_maths_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "initial_assessment_subject_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "initial_assessment_other_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "diagnostic_assessment_english_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "diagnostic_assessment_maths_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "diagnostic_assessment_subject_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "diagnostic_assessment_other_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "functional_skills_english_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                ...
                (
                    "career_objectives",
                    models.TextField(
                        blank=True, help_text="Career objectives", null=True
                    ),
                ),
                (
                    "relevant_past_work",
                    models.TextField(
                        blank=True, help_text="Relevant past work experience", null=True
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True, help_text="Achievements and awards", null=True
                    ),
                ),
                (
                    "assigned_instructor",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, help_text="Order of the question"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "totp_enabled",
                    models.BooleanField(
                        default=False, help_text="Enable TOTP authenticator app 2FA"
                    ),
                ),
                (
                    "totp_secret",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "assigned_at",
                    models.DateTimeField(
                        auto_now_add=True, help_text="When the quiz was assigned"
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether the assignment is active"
                    ),
                ),
                (
                    "notes",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subject",
                    models.CharField(
                        help_text="Subject or assessment name", max_length=255
                    ),
                ),
                (
                    "score",
                ...
                (
                    "assessment_date",
                    models.DateField(
                        blank=True, help_text="Date of assessment", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                fields=["branch", "role"], name="users_custo_branch__5df419_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                ...
                name="users_custo_last_lo_565cc4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                ...
                name="users_custo_role_752723_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",
        ...
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                fields=["branch", "date_joined"], name="users_custo_branch__bb7f4d_idx"
            ),
        ),
    ]
