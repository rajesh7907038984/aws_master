...
if [ -f "production.env" ]; then
    ...
    echo " No production.env or .env file found!"
    echo "   Please copy env_template to production.env and configure it for your server:"
    echo "   cp env_template production.env"
