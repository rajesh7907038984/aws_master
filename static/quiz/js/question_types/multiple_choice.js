const MultipleChoiceQuestion = {
        ...
        container.innerHTML = this.options.map((option, index) => `
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <input type="radio" name="correct_answers[]" value="${index}" class="form-check-input"
    ...
    addOption() {
        ...
        div.innerHTML = `
            ...
            <div class="input-group-append">
                <input type="radio" name="correct_answers[]" value="${optionCount}" class="form-check-input">
                <button type="button" class="btn btn-danger btn-sm remove-option">
                    <i class="fas fa-times"></i>
                </button>
            </div>
    ...
    validateAnswer() {
        ...
        const correctAnswer = this.form.querySelector('input[name="correct_answers[]"]:checked');
        
        return options.length >= 2 && correctAnswer;
    },
    ...
    getAnswerFields() {
        return `
            <div class="form-group">
                ...
                <div class="form-text">Add at least two options and select one correct answer.</div>
            </div>
        `;
    }
};

// Make MultipleChoiceQuestion available globally
