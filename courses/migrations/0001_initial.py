        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Brief description of the course",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Course code or identifier",
                        max_length=50,
                        null=True,
                    ),
                ),
                (
                    ...
                    core.utils.fields.TinyMCEField(
                        blank=True,
                        default="",
                        help_text="Expected learning outcomes for the course",
                    ),
                ),
                (
                    "course_rubrics",
                    core.utils.fields.TinyMCEField(
                        blank=True,
                        default="",
                        help_text="Assessment rubrics for the course",
                    ),
                ),
                (
                    "course_image",
                    models.ImageField(
                        ...
                        max_length=500,
                        null=True,
                        upload_to=courses.models.course_image_path,
                    ),
                ),
                (
                    "course_video",
                    models.FileField(
                        ...
                        max_length=500,
                        null=True,
                        upload_to=courses.models.course_video_path,
                    ),
                ),
                ...
                (
                    "require_enrollment",
                    models.BooleanField(
                        default=True, help_text="Require enrollment to access course"
                    ),
                ),
                (
                ...
                (
                    "all_topics_complete",
                    models.BooleanField(
                        default=False, help_text="Require all topics to be completed"
                    ),
                ),
                (
                    "minimum_score",
                    models.BooleanField(
                        default=False, help_text="Require minimum score to complete"
                    ),
                ),
                (
                    "certificate_type",
                ...
                (
                    "public_enrollment",
                    models.BooleanField(
                        default=True, help_text="Allow anyone to enroll in this course"
                    ),
                ),
                (
                    "enrollment_capacity",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instructions",
                    models.TextField(
                        blank=True, help_text="Instructions for completing this topic"
                    ),
                ),
                (
                    "content_type",
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text="URL for Web Content type topics",
                        max_length=500,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    core.utils.fields.TinyMCEField(
                        blank=True,
                        default="",
                        help_text="Rich text content for Text type topics",
                        null=True,
                    ),
                ),
                (
