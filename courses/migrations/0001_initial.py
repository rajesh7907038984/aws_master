    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(storage=core.s3_storage.MediaS3Storage(), upload_to='discussion_attachments/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_image', models.ImageField(blank=True, help_text='Course thumbnail image', max_length=500, null=True, upload_to=courses.models.course_image_path)),
                ('course_video', models.FileField(blank=True, help_text='Course introduction video', max_length=500, null=True, upload_to=courses.models.course_video_path)),
                ...
                ('scorm_mastery_score', models.FloatField(default=70.0, help_text='Default mastery score percentage for SCORM content (0-100)')),
                ('enable_mastery_auto_complete', models.BooleanField(default=True, help_text='Enable automatic completion based on mastery score achievement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('required_score', models.IntegerField(default=0, help_text='Minimum score required for this topic (0-100). 0 means just completion is required.')),
                ('is_mandatory', models.BooleanField(default=True, help_text='Whether this topic must be completed for course completion')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(choices=[('Video', 'Video'), ('Document', 'Document'), ('Text', 'Text'), ('Audio', 'Audio'), ('Web', 'Web Content'), ('Quiz', 'Quiz'), ('Assignment', 'Assignment'), ('SCORM', 'SCORM Package'), ('EmbedVideo', 'Embedded Video'), ('Conference', 'ILT/Conference'), ('Discussion', 'Discussion')], max_length=20)),
                ...
                ('web_url', models.URLField(blank=True, help_text='URL for Web Content type topics', max_length=500, null=True)),
                ('content_file', models.FileField(blank=True, help_text='Upload file for Video, Audio, Document content', max_length=255, null=True, upload_to=courses.models.content_file_path)),
